...
// // import property2 from 'src/assets/img/property-2.jpg';
// // import property3 from 'src/assets/img/property-3.jpg';
// // import property4 from 'src/assets/img/property-4.jpg';
// // import property5 from 'src/assets/img/property-5.jpg';
// // import property6 from 'src/assets/img/property-6.jpg';
...
//             <div className="grid grid-cols-2 gap-2">
//               <img className="w-full h-24 object-cover rounded-lg" src={property1} alt="" />
//               <img className="w-full h-24 object-cover rounded-lg" src={property1} alt="" />
//               <img className="w-full h-24 object-cover rounded-lg" src={property1} alt="" />
//               <img className="w-full h-24 object-cover rounded-lg" src={property1} alt="" />
//               <img className="w-full h-24 object-cover rounded-lg" src={property1} alt="" />
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            ...
            <p className="mb-2 hover:text-[#C7B198]">
              <FontAwesomeIcon icon={faEnvelope} style={{ color: "#f0ece3" }} className="mr-3" />info@example.com
            </p>
            <div className="flex space-x-2 mt-5">
              <a className="btn btn-outline-light p-2 border border-white rounded-full flip-icon" href="#">
