                            ...
                            {isAuthenticated ? (
                                ...
                                <>
                                    ...
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <Link to="/ower-login" className="bg-transparent text-[#F0ECE3] font-semibold border border-[#596E79] px-4 py-2 rounded-lg text-center hover:bg-gray-600 transition duration-300">Log In as Owner</Link>
                                    </div>
                                </>
                            )}
                        </div>
