        ...
        <nav className="bg-black bg-opacity-50 fixed top-0 left-0 w-full z-10 transition-colors duration-300 ease-in-out">
            <div className="max-w-full flex items-center justify-between py-4 px-4 mx-8">
                ...
                <div className="hidden lg:flex xl:flex flex-grow justify-end items-center space-x-6 font-serif">
                    ...
                    <Link to="/property" className="text-[#F0ECE3] text-lg uppercase font-semibold underline-from-center hover:text-[#C7B198]">Property</Link>
                            ...
                            {isAuthenticated ? (
                                ...
                                <>
                                    ...
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <Link to="/ower-login/:id" className="bg-transparent text-[#F0ECE3] font-semibold border border-[#596E79] px-4 py-2 rounded-lg text-center hover:bg-gray-600 transition duration-300">Log In as Ower</Link>
                                    </div>
                                </>
                            )}
                        </div>
