...
//       <form onSubmit={handleSubmit} className="space-y-4">
//         <div className="flex flex-col">
//           <label className="font-semibold text-gray-600 mb-2">PropertyType:</label>
//           <input
//             type="text"
//             name="name"
//             value={property.name}
...
//           <button
//             type="submit"
//             className="mt-6 px-6 py-3 bg-blue-500 text-white font-semibold rounded-md hover:bg-blue-600 transition-colors duration-300"
//           >
//             Add Property
//           </button>
//         </div>
...
// Dummy data for dropdown options; replace with your actual data
